   ...
   <div class="container">
      ...
      <div class="breadcrumbs">
         <ul>
            ...
            <li><span>Registration Form</span></li>
         </ul>
      </div>
   </div>
</section>
...
<div class="container my-3">
   <div class="row justify-content-center">
      <div class="col-md-12 text-center">
         <p class="">Jenis : {{$book->jenis}}</p>
         <p class="">Kategori : {{$book->kategori}}</p>
         <p class="">Jumlah : {{$book->jumlah}}</p>
         <p class="">Total Harga : {{$book->jumlah*$book->harga}}</p>
      </div>
      <div class="col-md-12">
         <form action="{{url('/ticket/check')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-row">

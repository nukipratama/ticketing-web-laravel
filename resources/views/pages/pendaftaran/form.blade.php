      ...
      <div class="form-row">
         <div class="form-group col-md-6">
            ...
            <input type="text" name="emailPemesan" id="emailPemesan"
               class="form-control  @if(count($errors)!==0) {{ $errors->has('emailPemesan') ? 'is-invalid' :  'is-valid'}} @endif"
         ...
         <section id="peserta{{$i+1}}">
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" name="namePeserta[]" value="{{old('namePeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('namePeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="email" name="emailPeserta[]" value="{{old('emailPeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('emailPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
            ...
            <div class="form-group">
               ...
               <input type="text" name="addressPeserta[]" value="{{old('addressPeserta.'.$i)}}"
                  class="form-control  @if(count($errors)!==0) {{ $errors->has('addressPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input type="tel" name="telPeserta[]" value="{{old('telPeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('telPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
                  @error('telPeserta.'.$i)
                  <div class="invalid-feedback">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="tel" name="emergencyPeserta[]" value="{{old('emergencyPeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('emergencyPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
            ...
            <div class="form-row">
               <div class="form-group col-md-4">
                  ...
                  <select name="genderPeserta[]" class="form-control" value="{{old('genderPeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('genderPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
               ...
               <div class="form-group col-md-4">
                  ...
                  <input type="date" name="birthdatePeserta[]" value="{{old('birthdatePeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('birthdatePeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
               ...
               <div class="form-group col-md-4">
                  ...
                  <input type="text" name="idPeserta[]" value="{{old('idPeserta.'.$i)}}" class="form-control
                      @if(count($errors)!==0) {{ $errors->has('idPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
                  @error('idPeserta.'.$i)
                  <div class="invalid-feedback">
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" name="communityPeserta[]" value="{{old('communityPeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('communityPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
               ...
               <div class="form-group col-md-6">
                  ...
                  <select name="sizePeserta[]" class="form-control" value="{{old('sizePeserta.'.$i)}}"
                     class="form-control @if(count($errors)!==0) {{$errors->has('sizePeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
                     <option value="null">Pilih..</option>
            ...
            <div class="form-row">
               <div class="form-group col-md-6">
                  ...
                  <input accept="image/*" type="file" name="imgPeserta[]" value="{{old('imgPeserta.'.$i)}}"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('imgPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif">
                  @error('imgPeserta.'.$i)
                  <div class="invalid-feedback">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" name="medicalPeserta[]"
                     class="form-control  @if(count($errors)!==0) {{ $errors->has('medicalPeserta.'.$i) ? 'is-invalid' :  'is-valid'}} @endif"
